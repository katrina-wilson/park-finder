    ...
    return (
        <div className="tw:flex tw:flex-col tw:w-full tw:h-full tw:bg-background">
            ...
            <InfoModal 
                ...
                text={  "These parks are picked because they share a lot in common with the one you’re checking out. Cosine similarity helps spot parks with similar types, amenities, locations, and ratings. \nClick any park card to dive into details, see photos, mark it as visited, and even leave a review!"}            />
